...
void vulkan_pipeline_bind(vulkan_command_buffer* command_buffer, VkPipelineBindPoint bindpoint, vulkan_pipeline* pipeline)
{
    vkCmdBindPipeline(command_buffer->handle, bindpoint, pipeline->handle);
}