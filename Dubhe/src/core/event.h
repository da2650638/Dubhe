 ...
 * @param callback The callback function pointer to be invoked when the event code is fired.
 * @returns TRUE if the event is successfully registered; otherwise false.
 */
DAPI b8 event_register(u16 code, void* listener, PFN_on_event callback);
 ...
 */
DAPI b8 event_unregister(u16 code, void* listener, PFN_on_event callback);
 ...
 */
DAPI b8 event_fire(u16 code, void* sender, event_context data);
...
typedef enum system_event_code {
    ...
    // Keyboard key pressed and released:
    /*
     * data usage: u16 key_code = data.data.u16[0];
     */
    ...
    /*
     * data usage: u16 button = data.data.u16[0];
     */
    ...
    // Mouse move
    /*
     * data usage: u16 x = data.data.u16[0], y = data.data.u16[1];
     */
     EVENT_CODE_MOUSE_MOVE = 0x06,

    // Mouse Scroll
    /*
     * data usage: u8 z = data.data.u8[0];
     */
    EVENT_CODE_MOUSE_WHEEL = 0x07,

    // Resized/resolution changed from the os
    /*
     * data usage: u16 width = data.data.u16[0], u16 height = data.data.u16[1];
     */
